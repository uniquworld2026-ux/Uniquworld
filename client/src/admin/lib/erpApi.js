...
export const erpApi = {
  ...
  getOrder: (id) =>
    api.get(`/erp/commerce/orders/${id}`, adminConfig()).then((r) => r.data.data.item),
  getOrderInvoice: (id, gstMode = 'with') =>
    api
  ...
  listInvoices: () =>
    api.get('/erp/commerce/invoices', adminConfig()).then((r) => r.data.data.items),
  getInvoice: (source, id) =>
    api.get(`/erp/commerce/invoices/${source}/${id}`, adminConfig()).then((r) => r.data.data.item),
  saveManualInvoice: (body) =>
    api.post('/erp/commerce/invoices', body, adminConfig()).then((r) => r.data.data.item),
  getInvoiceBank: () =>
    api.get('/erp/commerce/invoice-bank', adminConfig()).then((r) => r.data.data.bank),
  saveInvoiceBank: (body) =>
    api.put('/erp/commerce/invoice-bank', body, adminConfig()).then((r) => r.data.data.bank),
  getOrderTracking: (id) =>
    api.get(`/erp/commerce/orders/${id}/tracking`, adminConfig()).then((r) => r.data.data),
  sendOrderEmail: (id, body) =>
    api.post(`/erp/commerce/orders/${id}/email`, body, adminConfig()).then((r) => r.data.data),
  ...
  getShipment: (id) =>
    api.get(`/erp/commerce/shipments/${id}`, adminConfig()).then((r) => r.data.data.item),
  createShipment: (body) =>
  ...
  cancelShipment: (id, body) =>
    api.post(`/erp/commerce/shipments/${id}/cancel`, body, adminConfig()).then((r) => r.data.data.item),
  deleteShipment: (id) =>
