...
export const sitemap = [
  ...
  /* ── Store / Wholesale ───────────────────────────────────────────────── */
  {
    ...
    children: [
      ...
      { id: 'vendor', label: 'Vendor Registration', path: '/store/vendor', status: 'live' },
      { id: 'partner-login', label: 'Partner Login', path: '/store/partner/login', status: 'live' },
      { id: 'partner-dashboard', label: 'Partner Dashboard', path: '/store/partner', status: 'live' },
...
/** Primary header links — full-width icon / image strip */
