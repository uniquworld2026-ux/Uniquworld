...
export function InstallAppPrompt() {
  ...
  return createPortal(
    <div className="pointer-events-none fixed inset-x-0 bottom-[var(--uw-bottom-nav-h)] z-[80] flex justify-center p-3 pb-[max(0.75rem,env(safe-area-inset-bottom))] lg:hidden">
      <div
        role="dialog"
        aria-modal="true"
